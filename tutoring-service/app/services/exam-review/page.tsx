...
const examReviewCards: { type: string, card: JSX.Element }[] = [
  {
    ...
    card: <ServiceCard
      name={"CSI3131"}
      description={"June 15, 2025 @ University of Ottawa - Sometimes it feels like studying is a kernel-level instruction. Review with your peers in a session led by a computer engineering fourth year tutor."}
      icon={faCompactDisc}
  ...
  },
  {
    ...
    card: <ServiceCard
      ...
      description={
        "June 13, 2025 @ University of Ottawa - Meet students from across Ottawa and learn function graphing tricks from university students. \
